...
// Mirrors admin/scroll/page.tsx (2026-08-20) — Super Admin's Scrollbar
// module got the same /users/scroll/config/, /users/scroll/updates/, and
// /users/scroll/reorder/ endpoints Admin already had (opened on the backend
// the same day). No layout wrapper here — super-admin/* uses the file-based
// layout.tsx (Pattern B), unlike admin/* (Pattern A).
...
export default function SuperAdminScrollPage() {
