...
// ── Field label — replaced all-caps tracking with legible style (Gap 8) ───────
...
export default function AdminProfilePage() {
  ...
  const [nameSavedFlash, setNameSavedFlash] = useState(false); // Gap 4
  ...
  // Gap 2: opening name edit closes password form
  ...
  // Gap 2: opening password form cancels name edit
  ...
  // Gap 12: avatar upload — feature not yet available
  ...
  return (
    <AdminLayout>
      {/*
        Gap 7:  max-w-3xl (was max-w-2xl) — reduces excessive horizontal dead space
        Gap 3:  min-h fills viewport — eliminates the lower void on the default view
      */}
      <div
      ...
      >
        ...
        {/* Gap 10: position sticky keeps context during long form interaction     */}
        <div
        ...
        >
          {/* Avatar — interactive overlay for future photo upload (Gap 12) */}
          <button
            type="button"
        ...
        >
          ...
          >
            ...
            <p className="text-xs mt-0.5" style={{ color: "var(--color-text-muted)" }}>
              Email cannot be changed. Contact your Super Admin for email updates.
            </p>
          </div>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-3 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {editingName ? (
                      /* Gap 6: stacks to column on mobile, row on sm+ */
                      <form
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 sm:mt-1">
                          ...
                          {/* Gap 14: text-only Cancel — no confusing icon */}
                          <Button
                            type="button"
                            size="sm"
                            variant="secondary"
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {/* Gap 13: badge kept — concise constraint reinforcement */}
                    <span
        ...
        >
          {/*
            Gap 9: "Change Password" button stays right-aligned but the subtitle
            now contextually changes to guide the user when the form is open —
            giving the header semantic unity instead of a visually detached button.
          */}
          <div
          ...
          >
            ...
            {showPasswordForm ? (
              /* "Close" replaces "Change Password" when form is open */
              <button
                onClick={() => {
                  setShowPasswordForm(false);
                  pwForm.reset();
        ...
        {/* ── Account Information card — Gap 3 (fills dead space) + Gap 11 ────── */}
        {/* Shown whenever the backend returns date_joined (it does from this fix) */}
        {profile.date_joined && (
          <div
            className="rounded-2xl overflow-hidden"
            style={{
