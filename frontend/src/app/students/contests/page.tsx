...
const FEATURES = [
  "Live timed competitive rounds",
  "Real-time leaderboard & rankings",
  "Batch vs batch challenges",
  "Winner badges on your profile",
];
    ...
    <StudentLayout>
      <PageWrapper className="py-10 sm:py-16">
        <div className="w-full max-w-sm px-6 text-center mx-auto">
          ...
          >
            <Trophy size={36} style={{ color: "var(--color-accent)" }} />
          </div>
          ...
          >
            Compete live with your batchmates and climb the leaderboard in real placement-style rounds.
          </p>
