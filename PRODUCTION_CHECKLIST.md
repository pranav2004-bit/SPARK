...
- [ ] `django-migration-linter` must be added to each service's dev/CI requirements — blocks unsafe migrations (DROP COLUMN, RENAME COLUMN, NOT NULL without default) from reaching production — discovered during Phase 7 planning
